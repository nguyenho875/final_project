...
static void displayCharPositionWrite( uint8_t charPositionX, uint8_t charPositionY );
static void displayStringWrite( const char * str );
...
void displayWelcome() 
{
    ...
    displayStringWrite("enter PIN number");
}
