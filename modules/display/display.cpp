...
static void displayCodeWrite(bool type, unsigned char dataBus);
static void displayPinWrite(unsigned char pinName, int value);
static void displayDataBusWrite(unsigned char dataBus);
    ...
    switch( charPositionY ) {
        case 0:
            displayCodeWrite(DISPLAY_RS_INSTRUCTION, 
                             ...
                             (DISPLAY_20x4_LINE1_FIRST_CHARACTER_ADDRESS + charPositionX));
            delay(1);         
            break;
        ...
        case 1:
            displayCodeWrite(DISPLAY_RS_INSTRUCTION, 
                             DISPLAY_IR_SET_DDRAM_ADDR |
                             (DISPLAY_20x4_LINE2_FIRST_CHARACTER_ADDRESS + charPositionX));
            delay(1);         
            break;
        ...
        case 2:
            displayCodeWrite(DISPLAY_RS_INSTRUCTION, 
                             DISPLAY_IR_SET_DDRAM_ADDR |
                             (DISPLAY_20x4_LINE3_FIRST_CHARACTER_ADDRESS + charPositionX));
            delay(1);         
            break;
        ...
        case 3:
            displayCodeWrite(DISPLAY_RS_INSTRUCTION, 
                             DISPLAY_IR_SET_DDRAM_ADDR |
                             (DISPLAY_20x4_LINE4_FIRST_CHARACTER_ADDRESS + charPositionX));
            delay(1);         
            break;
    }
}
